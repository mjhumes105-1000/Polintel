...
const SEGMENTS: Segment[] = [
  {
    ...
    tags: ['National Security', 'Defense', 'Military', 'NDAA', 'Intelligence', 'Surveillance', 'FISA', 'Military Aid', 'Ukraine', 'Israel', 'Taiwan', 'Foreign Policy'],
    icon: '🛡️',
  ...
  },
  {
    ...
    tags: ['Immigration', 'Border Security', 'DHS', 'Public Safety', 'Asylum'],
    icon: '🗺️',
  ...
  },
  {
    ...
    tags: ['AI', 'Technology', 'Deepfakes', 'Cryptocurrency', 'Stablecoins', 'Financial Regulation', 'Online Safety', 'Child Protection', 'Social Media', 'SEC'],
    icon: '⚡',
  ...
  },
  {
    ...
    tags: ['Medicaid', 'Online Safety', 'Child Protection', 'Civil Liberties', 'Workers', 'Transportation', 'Aviation', 'Stimulus', 'COVID-19', 'Child Tax Credit', 'Labor', 'Unions', 'Minimum Wage'],
    icon: '👷',
  ...
  },
  {
    ...
    tags: ['Voting Rights', 'Elections', 'Voter ID', 'Voter Access', 'Election Integrity', 'Campaign Finance', 'Citizenship', 'Gerrymandering'],
    icon: '🗳️',
  ...
  },
  {
    ...
    tags: ['Medicaid', 'Healthcare', 'Drug Pricing', 'Public Health', 'Medicare', 'ACA', 'COVID-19', 'Universal Coverage'],
    icon: '🏥',
