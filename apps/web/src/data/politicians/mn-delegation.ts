...
const memberData: CongressMemberData[] = [
...

  {
    ...
    bio: 'Tom Emmer has served as House Majority Whip since January 2023 and has represented Minnesota\'s 6th Congressional District — covering St. Cloud and the northwest Minneapolis suburbs — since 2015. A former Minnesota state representative and attorney who played college hockey at William Mitchell College and St. John\'s University, he served as chairman of the National Republican Congressional Committee (2019–2023), helping Republicans win the House majority in 2022. He was elected Speaker on October 24, 2023 but withdrew from the role within hours after it became clear he lacked the votes to win a floor confirmation, citing opposition from the House Freedom Caucus and former President Trump.',
    sinceYear: 2015,
    committees: [
      { slug: 'hswh', name: 'House Majority Whip — Vote Counting', chamber: 'House', role: 'Chair' },
    ],
    previousOffices: [
      { title: 'Minnesota State Representative, 19B District', jurisdiction: 'Minnesota House of Representatives', startDate: '2004-01-13', endDate: '2009-01-06' },
      { title: 'Chairman, National Republican Congressional Committee', jurisdiction: 'U.S. House of Representatives', startDate: '2019-01-03', endDate: '2023-01-03' },
      { title: 'Attorney & Partner, Emmer & Associates', jurisdiction: 'Delano, Minnesota', startDate: '1994-01-01', endDate: '2004-01-01' },
    ],
    keyMilestones: [
      { year: 2004, description: 'Elected to Minnesota House of Representatives; built record on fiscal conservatism and regulatory reduction' },
      { year: 2014, description: 'Elected to U.S. House for Minnesota\'s 6th District, defeating Democrat Joe Persky with 57%' },
      { year: 2019, description: 'Elected Chairman of the NRCC, overseeing Republican House candidate recruitment, funding, and strategy for the 2020 and 2022 cycles' },
      { year: 2022, description: 'Led NRCC as Republicans retook the House majority — a smaller-than-expected gain of 9 seats that nonetheless returned Republicans to power for the first time since 2019' },
      { year: 2023, description: 'Elected Speaker of the House on October 24 — the third nominee in three weeks — but withdrew within hours after Trump publicly opposed him and Freedom Caucus members announced they would vote against him on the floor' },
    ],
    keyVotes: [
      {
        ...
        month: 11,
        position: 'Against',
        summary: 'Voted against the $1.2 trillion bipartisan infrastructure law, consistent with his position as a fiscal conservative and NRCC Chairman focused on drawing a partisan contrast with Democrats. Emmer argued the bill\'s spending was excessive and would contribute to inflation, positioning against the 13 House Republicans who voted for it.',
      },
      {
        ...
        month: 1,
        position: 'Against',
        summary: 'Voted to object to certification of Pennsylvania\'s electoral votes following the January 6th attack. As NRCC Chairman, Emmer had navigated difficult questions about election integrity in the 2020 cycle, trying to balance supporting House Republican incumbents in competitive districts while maintaining ties to Trump\'s base.',
      },
      {
        title: 'For: Fiscal Responsibility Act',
        year: 2023,
        month: 5,
        position: 'For',
        summary: 'Voted for the bipartisan debt ceiling deal, supporting a compromise that imposed spending caps and work requirements in exchange for raising the debt ceiling. As Whip, Emmer was involved in coordinating the Republican conference\'s vote on the deal.',
      },
      {
        ...
        month: 5,
        position: 'For',
        summary: 'As Majority Whip, tracked votes and managed the floor dynamics for passage of the Republican reconciliation bill. Emmer\'s whip operation was credited with the precise vote management that delivered the bill\'s narrow margin — a reflection of his 4-year tenure running the NRCC and understanding of what motivates individual Republican members.',
      },
    ],
    keyBills: [
      {
        ...
        year: 2024,
        month: 5,
        summary: 'Championed the FIT21 Act establishing a clear regulatory framework for cryptocurrency and digital assets, dividing oversight jurisdiction between the SEC and CFTC. Emmer has been the House\'s most prominent advocate for crypto regulation that creates legal clarity without stifling innovation — a position that has made him a leading figure in the digital assets policy space and earned him significant support from the crypto industry.',
      },
      {
        title: 'Anti-CBDC Surveillance State Act',
        year: 2023,
        month: 2,
        summary: 'Introduced legislation prohibiting the Federal Reserve from issuing a central bank digital currency directly to individuals — framing CBDCs as a government surveillance tool that would allow the federal government to monitor and potentially freeze Americans\' financial transactions. The bill reflected Emmer\'s positioning as a privacy-oriented fiscal conservative and his sustained focus on digital financial policy.',
      },
    ],
    topSectors: [
      { category: 'Finance & Cryptocurrency', amount: 920000, percentage: 36 },
      { category: 'Defense & Manufacturing', amount: 580000, percentage: 22 },
      { category: 'Agriculture & Rural Business', amount: 480000, percentage: 19 },
      { category: 'Individual Contributors', amount: 600000, percentage: 23 },
    ],
    recordAssessment: {
      whatTheRecordShows: [
        'Emmer has compiled a consistently conservative voting record focused on fiscal conservatism, deregulation, and digital financial innovation — with cryptocurrency policy as his most distinctive policy niche.',
        'His four years as NRCC chairman built significant relationships with House Republicans across the country, giving him an unusually broad coalition network for a member of his tenure.',
        'His failed Speaker bid in 2023 came despite broad conference support because Trump\'s public opposition was enough to deny him floor votes from a handful of loyalty-focused members.',
      ],
      whatWeObserve: [
        'Emmer is the most digitally savvy member of House Republican leadership on financial technology — a niche that has given him genuine policy influence and an unusual donor base in Silicon Valley and crypto.',
        'His failure to become Speaker was less a reflection of his standing in the conference than of Trump\'s veto power over any leadership choice. The episode illustrated that the Speaker\'s gavel now effectively requires presidential approval.',
        'Minnesota\'s 6th District is reliably Republican, giving Emmer significant electoral security to focus on national leadership duties rather than district-level competition.',
      ],
      whatIsUnresolved: [
        'Whether Emmer seeks a future Speaker bid — and whether Trump\'s blessing is a prerequisite — will be a defining question of the 119th Congress and beyond.',
      ],
    },
  },
