...
const SEGMENTS: Segment[] = [
  ...
  },
  {
    ...
    tags: ['Medicaid', 'Online Safety', 'Child Protection', 'Civil Liberties', 'Workers', 'Transportation', 'Aviation', 'Stimulus', 'COVID-19', 'Child Tax Credit'],
    icon: '👷',
  ...
  },
  {
    ...
    tags: ['Voting Rights', 'Elections', 'Voter ID', 'Voter Access', 'Election Integrity', 'Campaign Finance', 'Citizenship'],
    icon: '🗳️',
  ...
  },
  {
    ...
    tags: ['Medicaid', 'Healthcare', 'Drug Pricing', 'Public Health', 'Medicare', 'ACA', 'COVID-19'],
    icon: '🏥',
